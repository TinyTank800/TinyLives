...
//
        if(params.equals("lives")){
            if(Configs.Get("lives.yml").contains("lives." + Configs.Get("playerdata.yml").getInt("players." + player.getUniqueId() + ".lives"))){
                return Configs.Get("playerdata.yml").getInt("players." + player.getUniqueId() + ".lives") + "";
            } else {
                return "Unknown";
            }
        }
        ...
        if(params.equals("prefix")){
            if(Configs.Get("lives.yml").contains("lives." + Configs.Get("playerdata.yml").getInt("players." + player.getUniqueId() + ".lives"))){
                return Objects.requireNonNull(Configs.Get("lives.yml").getString("lives." + Configs.Get("playerdata.yml").getInt("players." + player.getUniqueId() + ".lives") + ".prefix"));
            } else {
                return "Unknown";
            }
        }
        ...
        if(params.equals("color")){
            if(Configs.Get("lives.yml").contains("lives." + Configs.Get("playerdata.yml").getInt("players." + player.getUniqueId() + ".lives"))){
                return Objects.requireNonNull(Configs.Get("lives.yml").getString("lives." + Configs.Get("playerdata.yml").getInt("players." + player.getUniqueId() + ".lives") + ".color"));
            } else {
                return "Unknown";
            }
        }

        if(params.equals("respawn_timer")){
            if(Configs.playerConfigs.get(player.getUniqueId()).contains("respawn-date")){
